...
с источниками — 209 страниц, крупный кегль:
**[скачать PDF (1,3 МБ)](./Гипертермический_синдром_и_тепловые_поражения_Монография.pdf)**

Растровых иллюстраций в PDF нет: они и слайды вынесены в [`СЛАЙДЫ.md`](СЛАЙДЫ.md).
...
[![Слайды](https://img.shields.io/badge/слайды_16:9-18-1d4ed8)](СЛАЙДЫ.md)
...
- **Визуальная навигация:** в каждой главе есть проверяемая Mermaid-схема для
  запоминания. Растровые иллюстрации и презентационные слайды вынесены в
  отдельный раздел — [`СЛАЙДЫ.md`](СЛАЙДЫ.md), с перечнем расхождений между
  слайдами и выправленным текстом глав.
...
assets/chapters/    исходные иллюстрации, в тексте больше не используются
