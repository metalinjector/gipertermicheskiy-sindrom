...
> [!WARNING]
> **Ограничения физостигмина.** Его избегают при признаках кардиотоксичности —
> прежде всего расширении QRS — и при высоком риске судорог. Классические
> сообщения об асистолии касались пациентов с тяжёлым отравлением трициклическими
> антидепрессантами; при последующем разборе фатальный исход связывали скорее с
> самой ТЦА-интоксикацией, чем с физостигмином, а при нормальной длительности QRS
> введение расценивают как вероятно безопасное (Arens et al., 2017). При
...
| **Салицилаты, 2,4-динитрофенол (DNP)** | разобщение окислительного фосфорилирования | гипервентиляция, смешанные нарушения КОС, быстро нарастающая гипертермия | охлаждение, коррекция КОС и электролитов, при тяжёлом отравлении — гемодиализ; при салицилатах обсуждают ощелачивание |
...
1. **СТОП** — прекратить подачу всех галогенсодержащих анестетиков и
   ...
   современным рекомендациям в дыхательный контур устанавливают **активированные
   угольные фильтры**, что позволяет быстро снизить концентрацию анестетика на
   имеющемся аппарате;
...
вносит влажность: по мере её роста эффективность испарения пота падает, и при
относительной влажности порядка 75 % и выше испарительное охлаждение становится
малоэффективным даже при умеренной температуре воздуха. Физически испарение при
...
3. **при судорожной готовности или судорогах** — диазепам 0,3–0,5 мг/кг;
...
*О физостигмине.* Исторически его считали противопоказанным при отравлении ТЦА
из-за сообщений об асистолии. Современная трактовка точнее:

- решающим является **не сам факт приёма ТЦА, а наличие кардиотоксичности**;
  ключевой показатель — длительность QRS;
- при **расширенном QRS, брадикардии или судорогах** физостигмин не применяют;
- при **нормальном QRS** (как в этой задаче — 88 мс) введение расценивают как
  вероятно безопасное, а классические фатальные случаи при повторном разборе
  связывали скорее с тяжестью самой ТЦА-интоксикации;
- при использовании — **низкие титрованные дозы 0,5–1 мг** внутривенно медленно
  с интервалом не менее 10–15 минут, под контролем ЭКГ и с готовностью к
  холинергическим осложнениям (судороги примерно у 2,5 %).

*Практический вывод:* здесь физостигмин допустим при рефрактерном к
бензодиазепинам делирии, но не обязателен — приоритет остаётся за охлаждением,
седацией и мониторингом.
