...
4. Избыток Ca²⁺ вызывает стойкое непрекращающееся сокращение — **контрактуру**.
   ...
   частую нервную стимуляцию и исчезает при её прекращении или после введения
   миорелаксанта. Контрактура при MH возникает внутри самой мышечной клетки,
   не зависит от нервного импульса и **не устраняется недеполяризующими
   миорелаксантами** — практически важный признак у постели больного.
...
- **Тиреотоксический криз.** Избыток тиреоидных гормонов резко повышает общий
  ...
  следует считать ошибочной: UCP1 не является основным медиатором тиреоидного
  термогенеза — при тиреотоксикозе экспрессия UCP1, напротив, снижается, а бурый
  жир инактивируется. Прямое UCP1-подобное разобщение остаётся механизмом
  химических разобщителей, а не тиреоидных гормонов.
